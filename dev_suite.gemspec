...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{A suite of development tools.}
  spec.description   = %q{Provides tools for performance analysis, folder structure visualization, and custom curl command generation.}
  ...
  spec.add_runtime_dependency "benchmark", "~> 0.1"
